...
const popularPrivateDestinations = [
    ...
    <div className="bg-[#F8FAFC] text-foreground min-h-screen font-sans selection:bg-[#0284C7] selection:text-white pb-0">
      ...
      <section className="relative w-full h-[70vh] md:h-[80vh] overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center pt-20">
          ...
          >
            Rancang Perjalanan Pribadi Anda
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Setiap perjalanan adalah kanvas kosong. Nikmati kebebasan penuh, layanan eksklusif, dan jadwal yang disesuaikan hanya untuk Anda dan orang-orang terkasih.
          </motion.p>
          <motion.button
            ...
            className="bg-[#0284C7] hover:bg-[#0ea5e9] text-white px-8 py-4 rounded-full font-sans font-bold text-xs md:text-sm tracking-widest uppercase transition-all duration-300 shadow-[0_0_20px_rgba(2,132,199,0.4)] hover:shadow-[0_0_30px_rgba(2,132,199,0.6)] hover:-translate-y-1"
          >
            Mulai Merancang
          </motion.button>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 -mt-16 relative z-20 mb-24">
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100 grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-4 divide-y md:divide-y-0 md:divide-x divide-gray-100">
          ...
          <div className="flex flex-col items-center text-center px-4 pt-6 md:pt-0">
            ...
            <h3 className="font-serif text-xl text-[#0F2C59] mb-3">Kebebasan Rute</h3>
            <p className="text-gray-500 text-sm font-light leading-relaxed">Tentukan sendiri destinasi impian Anda, tanpa terikat jadwal grup wisata umum.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-4 pt-6 md:pt-0">
            ...
            <h3 className="font-serif text-xl text-[#0F2C59] mb-3">Fleksibilitas Waktu</h3>
            <p className="text-gray-500 text-sm font-light leading-relaxed">Berangkat kapan saja. Habiskan waktu lebih lama di tempat yang Anda sukai.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-4 pt-6 md:pt-0">
            ...
            <h3 className="font-serif text-xl text-[#0F2C59] mb-3">Layanan Eksklusif</h3>
            <p className="text-gray-500 text-sm font-light leading-relaxed">Dari hotel butik mewah hingga kendaraan pribadi yang sangat nyaman.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center px-4 pt-6 md:pt-0">
            ...
            <h3 className="font-serif text-xl text-[#0F2C59] mb-3">Privasi Penuh</h3>
            <p className="text-gray-500 text-sm font-light leading-relaxed">Hanya Anda, keluarga, atau kerabat terdekat. Tanpa ada orang asing.</p>
          </div>
        ...
        <div className="bg-[#0F2C59] rounded-[2rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row">
          ...
          <div className="lg:w-5/12 p-10 md:p-16 relative flex flex-col justify-center">
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6 relative z-10 leading-tight">
              Ceritakan Perjalanan Impian Anda.
            </h2>
            <p className="font-sans text-white/70 text-sm md:text-base font-light mb-10 relative z-10 leading-relaxed">
              Tim Travel Expert kami siap membantu Anda menyusun itinerary eksklusif, mengatur akomodasi bintang 5, hingga memastikan setiap detail perjalanan berjalan sempurna tanpa cela.
            </p>
            <div className="space-y-6 relative z-10">
              <div className="flex items-center gap-4 text-white/80">
                ...
                <span className="font-sans text-sm font-light">100% Jadwal Fleksibel</span>
              </div>
              <div className="flex items-center gap-4 text-white/80">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                  <Star size={20} className="text-[#0284C7]" />
                </div>
                <span className="font-sans text-sm font-light">Standar Akomodasi Premium</span>
              </div>
              <div className="flex items-center gap-4 text-white/80">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                  <CheckCircle2 size={20} className="text-[#0284C7]" />
                </div>
                <span className="font-sans text-sm font-light">Penanganan Khusus & VIP</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-7/12 bg-white p-8 md:p-16">
            ...
            <form onSubmit={handleWhatsappSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block font-sans text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Destinasi Tujuan</label>
                  <input 
                    type="text" 
                    name="destination"
                    required
                    ...
                    placeholder="Contoh: Jepang, Eropa..." 
                ...
                <div>
                  <label className="block font-sans text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Estimasi Waktu</label>
                  <input 
                    type="text" 
                    name="date"
                    required
                    value={formData.date}
                    onChange={handleInputChange}
                    placeholder="Contoh: Akhir Tahun 2026" 
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3.5 text-sm text-[#0F2C59] focus:outline-none focus:ring-2 focus:ring-[#0284C7]/50 focus:border-[#0284C7] transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block font-sans text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Jumlah Peserta (Pax)</label>
                <input 
                  type="text" 
                  name="pax"
                  required
              ...
              <div>
                <label className="block font-sans text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Catatan / Kebutuhan Khusus</label>
                <textarea 
                  name="notes"
                  rows={4}
                  value={formData.notes}
                  onChange={handleInputChange}
                  placeholder="Ceritakan ekspektasi Anda (contoh: saya ingin hotel bintang 5 dengan private pool...)" 
              ...
              <button 
                type="submit"
                className="w-full bg-[#0F2C59] hover:bg-[#0284C7] text-white rounded-xl py-4 flex items-center justify-center gap-3 transition-all duration-300 font-sans font-bold text-sm tracking-widest uppercase mt-4 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
              >
